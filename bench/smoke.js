...
a.send(JSON.stringify({ type: 'set_block', x: 5, y: 30, z: 5, id: 7 }));
...
check('set_block echoed to sender', updates.length === 1 && updates[0].x === 5 && updates[0].id === 7, JSON.stringify(updates));
